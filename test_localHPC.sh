...
base_command="/usr/bin/time nextflow run contents/main.nf -profile localHPC -c params/nextflow.config -w testwork -resume --apptainer.enabled true"
...
run "Run a tiered HiC 3.0 (DdeI,DpnII) downsampled condition from Akgol 2021 with bwa using resource files created in the last test." "$base_command --sampleFile vignettes/akgol2021/samples_bwa.tsv -params-file params/tiered_bulk.yml"
